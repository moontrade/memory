...
//	return func(pagesBefore, pagesNeeded int32, minSize uintptr) (pagesAdded int32, start, end Pointer) {
...
//
//func GrowMin() Grow {
//	return func(pagesBefore, pagesNeeded int32, minSize uintptr) (int32, Pointer, Pointer) {
...
//	segment := Pointer(malloc(size))
//	return bootstrap(segment, segment+size, pages, grow)
//}

//func (a *TLSF) Grow(pages int32) (Pointer, Pointer) {
//	if pages <= 0 {
//		pages = 1
//	}
