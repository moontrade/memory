...
func TestTreeDump4(t *testing.T) {
	n4 := factory.newNode4()
	n4leaf := factory.newLeaf(keyOf("key4"), "value4")
...
func TestTreeDump4BinaryValue(t *testing.T) {
	n4 := factory.newNode4()
	n4leaf := factory.newLeaf(keyOf("key4"), keyOf("value4"))
	n4._addChild4('k', true, n4leaf)
...
func TestTreeDump4Int(t *testing.T) {
	n4 := factory.newNode4()
	n4leaf := factory.newLeaf(keyOf("key4"), 4)
	n4._addChild4('k', true, n4leaf)
...
func TestTreeDump2NodeWithIntValue(t *testing.T) {
	...
	n16_2leaf := factory.newLeaf(keyOf("zima"), 4)
	n16_2.addChild('z', true, n16_2leaf)

	n16leaf := factory.newLeaf(keyOf("key4"), 4)
	c4leaf := factory.newLeaf(keyOf("cey4"), 44)
...
func TestTreeDump16(t *testing.T) {
	n16 := factory.newNode16()
	n16leaf := factory.newLeaf(keyOf("key16"), "value16")
	n16.addChild('k', true, n16leaf)
...
func TestTreeDump48(t *testing.T) {
	...
	n48leaf := factory.newLeaf(keyOf("key48"), "value48")
...
func TestTreeDump256(t *testing.T) {
	...
	n256leaf := factory.newLeaf(keyOf("key256"), "value256")
